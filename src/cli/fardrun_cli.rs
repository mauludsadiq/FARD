...
impl Cli {
    pub fn parse_compat() -> (RunArgs, bool, bool, Option<TestArgs>, Option<PublishArgs>, Option<InstallArgs>, Option<NewArgs>, Option<VerifyArgs>, Option<EvalArgs>) {
        ...
        (run, false, false, None, None, None, None, None, None)
    }
}
